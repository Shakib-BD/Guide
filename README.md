# ***Changing Your Old Commit Messages***
...
For push it in github repository. Use force push command.
...
If you want to change the last 3 commit messages, or any of the commit messages up to that point, supply '_HEAD~3_' to the '_git rebase -i_' command.
